...
export function canConnect(grid: Tile[][], r1: number, c1: number, r2: number, c2: number): boolean {
...
export function findHint(grid: Tile[][]): [{ r: number; c: number }, { r: number; c: number }] | null {
