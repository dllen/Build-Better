...
export default function ChmodCalculator() {
  ...
  const symbolic = useMemo(() => {
    const seg = (who: string, t: Tri) =>
      `${who}=${t.r ? "r" : ""}${t.w ? "w" : ""}${t.x ? "x" : ""}`.replace(/=$/, "=none");
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4 space-y-3">
          ...
          <label className="inline-flex items-center gap-2 text-sm">
            <input
              type="checkbox"
              checked={u.r}
              onChange={(e) => setU({ ...u, r: e.target.checked })}
            />{" "}
            读 r
          </label>
          <label className="inline-flex items-center gap-2 text-sm">
            <input
              type="checkbox"
              checked={u.w}
              onChange={(e) => setU({ ...u, w: e.target.checked })}
            />{" "}
            写 w
          </label>
          <label className="inline-flex items-center gap-2 text-sm">
            <input
              type="checkbox"
              checked={u.x}
              onChange={(e) => setU({ ...u, x: e.target.checked })}
            />{" "}
            执行 x
          </label>
        </div>
        <div className="bg-white rounded-lg border border-gray-200 p-4 space-y-3">
          ...
          <label className="inline-flex items-center gap-2 text-sm">
            <input
              type="checkbox"
              checked={g.r}
              onChange={(e) => setG({ ...g, r: e.target.checked })}
            />{" "}
            读 r
          </label>
          <label className="inline-flex items-center gap-2 text-sm">
            <input
              type="checkbox"
              checked={g.w}
              onChange={(e) => setG({ ...g, w: e.target.checked })}
            />{" "}
            写 w
          </label>
          <label className="inline-flex items-center gap-2 text-sm">
            <input
              type="checkbox"
              checked={g.x}
              onChange={(e) => setG({ ...g, x: e.target.checked })}
            />{" "}
            执行 x
          </label>
        </div>
        <div className="bg-white rounded-lg border border-gray-200 p-4 space-y-3">
          ...
          <label className="inline-flex items-center gap-2 text-sm">
            <input
              type="checkbox"
              checked={o.r}
              onChange={(e) => setO({ ...o, r: e.target.checked })}
            />{" "}
            读 r
          </label>
          <label className="inline-flex items-center gap-2 text-sm">
            <input
              type="checkbox"
              checked={o.w}
              onChange={(e) => setO({ ...o, w: e.target.checked })}
            />{" "}
            写 w
          </label>
          <label className="inline-flex items-center gap-2 text-sm">
            <input
              type="checkbox"
              checked={o.x}
              onChange={(e) => setO({ ...o, x: e.target.checked })}
            />{" "}
            执行 x
          </label>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="bg-white rounded-lg border border-gray-200 p-4 space-y-3">
          ...
          <label className="inline-flex items-center gap-2 text-sm">
            <input
              type="checkbox"
              checked={spec.suid}
              onChange={(e) => setSpec({ ...spec, suid: e.target.checked })}
            />{" "}
            setuid
          </label>
          <label className="inline-flex items-center gap-2 text-sm">
            <input
              type="checkbox"
              checked={spec.sgid}
              onChange={(e) => setSpec({ ...spec, sgid: e.target.checked })}
            />{" "}
            setgid
          </label>
          <label className="inline-flex items-center gap-2 text-sm">
            <input
              type="checkbox"
              checked={spec.sticky}
              onChange={(e) => setSpec({ ...spec, sticky: e.target.checked })}
            />{" "}
            sticky
          </label>
        </div>
        <div className="bg-white rounded-lg border border-gray-200 p-4 space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div className="rounded-md border border-gray-200 px-3 py-2 font-mono">
              八进制: {octal}
            </div>
            <div className="rounded-md border border-gray-200 px-3 py-2 font-mono">
              权限串: {permStr}
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4 space-y-3">
          ...
          <input
            ...
            placeholder="如 755 或 u=rwx,g=rx,o=rx 或 a+rx"
            value={input}
